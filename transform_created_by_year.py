...
def transformNameBasics() -> None:
    ...
    fileTTL.write("@prefix imdb: <http://www.h-da.de/sis/lda/imdb/> .\n")
...
def transformTitlePrincipals() -> None:
    ...
    fileTTL.write("@prefix imdb: <http://www.h-da.de/sis/lda/imdb/> .\n")
    fileTTL.write("@prefix principals: <http://www.h-da.de/sis/lda/imdb/principals/> .\n")
